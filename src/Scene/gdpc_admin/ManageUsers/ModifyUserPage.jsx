...
import Permission from '../../../Component/ModifyProfile/Permission';
    ...
    <Container maxWidth="lg" sx={{ minHeight: '100vh' }} my={2} >
        <BreadNav
          path={
            [
              ...
              { path: '/gdpc_admin/manage_users/edit_profile', name: 'Modify User Profile' }
            ]
          }
        />
        ...
        <Grid container spacing={2} alignItems="flex-start">
            <Grid item xs={12} md={6}>
                <Permission user_id={user_id} email={user.email} status={user.status} />
            </Grid>
            <Grid item xs={12} md={6}>
